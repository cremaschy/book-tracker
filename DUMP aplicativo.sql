...
CREATE TABLE `dailystats` (
  ...
  CONSTRAINT `dailystats_ibfk_1` FOREIGN KEY (`id_usuario`) REFERENCES `usuarios` (`id_usuario`)
) ENGINE=InnoDB AUTO_INCREMENT=11 DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;

/*Data for the table `dailystats` */

insert  into `dailystats`(`id_ds`,`data_leitura`,`total_paginas_lidas`,`tempo_leitura`,`id_usuario`) values 
(1,'2026-03-20',25,'01:00:00',1),
(2,'2026-03-21',30,NULL,1),
(3,'2026-03-21',15,'00:45:00',2),
(4,'2026-03-22',40,'02:00:00',3),
(5,'2026-03-22',10,NULL,4),
(6,'2026-03-23',50,'02:10:00',5),
(7,'2026-03-23',20,NULL,2),
(8,'2026-03-24',35,'01:30:00',3),
(9,'2026-03-25',60,'02:30:00',1),
(10,'2026-03-25',22,NULL,4);
...
(4,'Diego Alves','diego.alves@email.com'),
(5,'Fernanda Rocha','fernanda.rocha@email.com'),
(6,'José Henrique',NULL);
