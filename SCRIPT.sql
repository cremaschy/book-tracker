...
('Ana Souza', 'ana.souza@email.com', '12345678'),
('Bruno Lima', 'bruno.lima@email.com', '12345678'),
('Carla Mendes', 'carla.mendes@email.com', '12345678'),
('Diego Alves', 'diego.alves@email.com', '12345678'),
('Fernanda Rocha', 'fernanda.rocha@email.com', '12345678');
...
(data_leitura, total_paginas_lidas, tempo_leitura, id_livro, id_usuario) 
VALUES
('2026-03-20', 25, '01:00:00', 1, 1),
('2026-03-21', 30, NULL, 1, 2),
('2026-03-21', 15, '00:45:00', 2, 3),
('2026-03-22', 40, '02:00:00', 3, 4),
('2026-03-22', 10, NULL, 4, 5),
('2026-03-23', 50, '02:10:00', 5, 1),
('2026-03-23', 20, NULL, 2, 2),
('2026-03-24', 35, '01:30:00', 3, 3),
('2026-03-25', 60, '02:30:00', 1, 4),
('2026-03-25', 22, NULL, 4, 5);